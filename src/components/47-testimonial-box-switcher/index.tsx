...
const TestimonialBoxSwitcher: FC = () => {
    const [testimonial, setTestimonial] = useState(0);

    useEffect(() => {
        const interval = setInterval(() => {
            setTestimonial(prev => Math.floor((prev + 1) % TESTIMONIALS.length))
        }, 10000)
            ...
            <div className="testimonial-container">
                ...
                <div className="user">
                    ...
                    <div className="user-details">
                        <h4 className="username">{TESTIMONIALS[testimonial].name}</h4>
                        <p className="role">{TESTIMONIALS[testimonial].position}</p>
                    </div>
                </div>
            </div>
        </main>
